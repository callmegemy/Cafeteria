    ...
    <nav class="navbar navbar-expand-lg navbar-dark">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav mr-auto">
                ...
                <li <?php if ($data['perm_id'] == 1) {
                        echo "hidden";
                    } ?> class="nav-item"><a class="nav-link" href="allProducts.php">Products</a></li>
                <li <?php if ($data['perm_id'] == 1) {
                        echo "hidden";
                    } ?> class="nav-item"><a class="nav-link" href="allUsers.php">Users</a></li>
                <li <?php if ($data['perm_id'] == 1) {
                        echo "hidden";
                    } ?> class="nav-item"><a class="nav-link" href="orders.php"> Orders</a></li>
                <li <?php if ($data['perm_id'] == 1) {
                        echo "hidden";
                    } ?> class="nav-item"><a class="nav-link" href="Checks.php">Checks</a></li>
            </ul>
