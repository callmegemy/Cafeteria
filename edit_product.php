          ...
          <form class="w-100 p-2" action="functions/update_product.php" method="post" enctype="multipart/form-data">
            ...
            <div class="mb-3">
              ...
              >
                ...
                ?>
                <option <?php if($data['categ_id']==$categ['id']){echo "selected";} ?> value="<?php echo $categ['id'] ?>"><?php echo $categ['name'] ?></option>
              <?php } ?>
              </select>
              <span class="text-danger">
            ...
            <div class="mb-3">
              ...
              >
                ...
                ?>
                <option <?php if($data['status']==$status['id']){echo "selected";} ?> value="<?php echo $status['id'] ?>"><?php echo $status['name'] ?></option>
              <?php } ?>
              </select>
              <span class="text-danger">
                    <?php $error=isset($errors['status'])? $errors['status']: ''; echo $error; ?>
                    </span>
            </div>
